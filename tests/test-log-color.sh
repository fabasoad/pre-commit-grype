...
test_log_color_param_precedence() {
  ...
  output=$(PRE_COMMIT_GRYPE_LOG_COLOR="${log_color_env_var}" \
...
main() {
  ...
  test_log_color_param_precedence "grype-dir" "true" "false" "true"
  test_log_color_param_precedence "grype-dir" "false" "true" "false"
  test_log_color_env_var "grype-dir" "true"
  test_log_color_env_var "grype-dir" "false"
